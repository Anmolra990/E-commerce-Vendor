          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2 space-y-4">
              {cart.items.map((item) => {
                ...
                const itemTitle = product.title || product.name || "Product";
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto pt-3 sm:pt-0 border-t sm:border-0 border-slate-100">
                      ...
                      <div className="flex items-center bg-slate-100 rounded-xl p-1 border border-slate-200">
                        <button
                          className="w-8 h-8 rounded-lg bg-white text-slate-700 font-bold hover:bg-slate-200 disabled:opacity-40 disabled:hover:bg-white shadow-xs flex items-center justify-center transition"
                          onClick={() =>
                        ...
                        <button
                          className="w-8 h-8 rounded-lg bg-white text-slate-700 font-bold hover:bg-slate-200 shadow-xs flex items-center justify-center transition"
                          onClick={() =>
                            updateQuantity(product._id, item.quantity + 1)
                          }
                        >
...
<div className="lg:col-span-3 bg-slate-50 rounded-3xl border border-slate-200 p-5">
                <h3 className="text-lg font-semibold text-slate-900 mb-3">
                  Delivery Address
                </h3>
                <SavedAddressBook selectedAddressId={deliveryAddress?._id} onSelect={setDeliveryAddress} />
              </div>
              <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm sticky top-8 lg:col-start-3 lg:row-start-1">
